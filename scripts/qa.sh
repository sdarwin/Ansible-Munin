...
# Instructions:
#
# curl -sL https://raw.githubusercontent.com/sdarwin/Ansible-Munin/develop/scripts/qa.sh | sudo bash
#
#
...
sudo git clone https://github.com/sdarwin/Ansible-Munin sdarwin.munin
